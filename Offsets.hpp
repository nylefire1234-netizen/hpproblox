...
/*  Dumped At       : 18:10 09/09/2026 (GMT)
/*  Total Offsets   : 392
/* -------------------------------------------------------------
/*  Join the discord!                                           
...
namespace Offsets {
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t AutoRotate = 0xe5;
    ...
    namespace Tool {
         inline constexpr uintptr_t CanBeDropped = 0x295;
         ...
         inline constexpr uintptr_t RequiresHandle = 0x195;
